...
export function makeAgentPrTool(_ctx?: OpenClawPluginToolContext, options: { metadataProvider?: PrMetadataProvider } = {}) {
  return {
    ...
    parameters: Type.Object({
      ...
      base_branch: Type.Optional(Type.String({ description: "Literal Git branch name for the PR; options and revision expressions are rejected (default: detected from repo)" })),
